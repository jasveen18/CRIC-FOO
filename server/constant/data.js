const data = [
    {
        ...
        url: `https://www.cricbuzz.com/a/img/v1/595x396/i1/c215095/fakhar-has-scored-only-88-runs.jpg`,
        timestamp: ` Fri, Oct 8, 2021, 06:35 PM`,
        link: `https://www.cricbuzz.com/cricket-news/119355/icc-mens-t20-world-cup-2021-fakhar-sarfaraz-haider-included-in-pakistans-15-for-t20-wc`,
        publisher: `Cricbuzz`
    },
    {
        title: `ECB revise men's contract model, offer 20 annual central contracts`,
        author: `Rob Johnston`,
        description: `The ECB say the change in structure, worked on in conjunction with the Team England Player Partnership (TEPP) and the Professional Cricketers' Association (PCA), "is designed to meet England's future needs in what has become a fluid and dynamic landscape" and also take into consideration the COVID-19 landscape which will continue to have an impact on availability.`,
        url: `https://www.cricbuzz.com/a/img/v1/595x396/i1/c215090/on-the-list-of-20-players-daw.jpg`,
        timestamp: `Fri, Oct 8, 2021, 06:35 PM`,
        link: `https://www.cricbuzz.com/cricket-news/119352/ecb-revise-mens-contract-model-offer-20-annual-central-contracts`,
        publisher: `Cricbuzz`
    },
    {
        title: `T20 World Cup: PCB to get blank cheque if Pakistan beat India, says Ramiz Raza`,
        author: `ANI`,
        description: `KARACHI (Pakistan): Pakistan Cricket Board (PCB) chairman Ramiz Raja has revealed that PCB will get a blank cheque if the Babar Azam-led side beat India in the upcoming T20 World Cup. India will face Pakistan in their opening game at the ICC Men's T20 World Cup 2021 at Dubai International Stadium on October 24.`,
        url: `https://static.toiimg.com/thumb/msid-86846002,imgsize-25774,width-400,resizemode-4/86846002.jpg`,
        timestamp: `Thu, Oct 7, 2021, 22:02 IST`,
        link: `http://timesofindia.indiatimes.com/articleshow/86846039.cms?utm_source=contentofinterest&utm_medium=text&utm_campaign=cppst`,
        publisher: `The Times of India`
    },
    {
        title: 'KKR leave MI needing miracle for playoff spot',
        author: 'Narbavi R',
        description: 'MI need to win by 171 runs after scoring more than 200 to go past KKRs net run rate',
        url: 'https://www.cricbuzz.com/a/img/v1/595x396/i1/c214955/mi-need-to-win-by-171-runs-aft.jpg',
        timestamp: 'Thu, Oct 7, 2021, 11:04 PM',
        link: 'https://www.cricbuzz.com/cricket-news/119334/kkr-leave-mi-needing-miracle-for-playoff-spot',
        publisher: 'Cricbuzz'
    },
    {
        title: ' Deepak Chahar Proposes To Girlfriend After CSK IPL Game, She Said Yes',
        author: 'Neelav Chakravarti',
        description: `Despite a defeat to Punjab Kings (PBKS), Chennai Super Kings (CSK) player Deepak Chahar ended the day on an extremely happy note as he proposed to his girlfriend after the game and she said yes. After CSK's defeat in Match 53 of the ongoing Indian Premier League (IPL) 2021 season, Chahar went to the stands and took his girlfriend by surprise, who was dressed in black. Chahar posted a video of the proposal on Instagram and captioned it as, "Special moment".`,
        url: `https://c.ndtvimg.com/2021-10/k05ccj5g_deepak-chahar-with-girlfriend-instagram_625x300_07_October_21.jpg?output-quality=80&downsize=1278:`,
        timestamp: 'Thu, Oct 7, 2021, 8:20 PM ',
        link: 'https://sports.ndtv.com/ipl-2021/deepak-chahar-proposes-to-girlfriend-after-csks-ipl-game-she-said-yes-watch-2567516',
